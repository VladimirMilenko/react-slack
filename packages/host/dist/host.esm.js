...
var RedisSlackContainer = function RedisSlackContainer(subClient, handlerRegistry) {
  ...
  this.onCommited = function () {
    ...
    if (!isEqual(_this.lastCommited, nextCommit)) {
...
export { Actions, Button, Context, DatePicker, Divider, Markdown, ObjectSlackContainer, RedisSlackContainer, Section, SectionAccessory, SectionFields, SectionText, SlackDOM };
